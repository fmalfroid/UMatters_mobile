...
public class RepliesListActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.action_help){
            openHelpDialog(RepliesListActivity.this);
        }
    ...
    private void initFAB(){
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent runApp = new Intent(getApplicationContext(), ReplyActivity.class);
                runApp.putExtra("box", currentBox);
                runApp.putExtra("comment", currentComment);
