...
public class LikeBoxComment extends AsyncTask<String, String, String> {
    ...
    public LikeBoxComment(Context context, CommentListAdapter commentListAdapter, String id_box, String user_email){
    ...
    protected void onPostExecute(String result) {
        if (result == null) {
            ...
            try {
                ...
                //Delete succeed
                if (success) {
                    commentListAdapter.toggleFavorite(user_email);
                }
                //Delete failed
                else {
                }
