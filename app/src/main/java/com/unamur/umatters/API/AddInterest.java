...
public class AddInterest extends AsyncTask<String, String, String> {
    ...
    public AddInterest(Context context, BoxListAdapter boxListAdapter, String id_box, String user_email){
    ...
    protected void onPostExecute(String result) {
        if (result == null) {
            ...
            try {
                ...
                //Delete succeed
                if (success) {
                    boxListAdapter.toggleInterest(id_box, user_email);
                }
                //Delete failed
                else {
                }
