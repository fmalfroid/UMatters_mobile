...
public class LikeReply extends AsyncTask<String, String, String> {

    private RepliesListAdapter commentListAdapter;
    private String id_comment;
    private String id_box;
    private String user_email;
    private Context context;

    public LikeReply(Context context, RepliesListAdapter commentListAdapter, String id_comment, String id_box, String user_email){
