...
public class AddBox extends AsyncTask<String, String, String> {

    private Context context;

    public AddBox(Context context){
        ...
        if (result == null) {
            ...
            try {
                ...
                //Delete failed
                    ...
                    Toast.makeText(context, R.string.error_add_box, Toast.LENGTH_SHORT).show();
                }
