...
public class ArchivesRefusedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Box box_2 = new Box("-2", list_choice_2, user_2, "17-11-98", likes_2, tags_2, "Ceci est une archive test avec 3 partout.", "textuelle", "Petite description.");

        ArrayList<String> list_response_2 = new ArrayList<>();
        list_response_2.add("1ere reponse");
        list_response_2.add("2e reponse");
        list_response_2.add("3e reponse");

        ArrayList<String> list_response_date_2 = new ArrayList<>();
        list_response_date_2.add("24-04-2020");
